...
class MembershipLevelApi
{
    ...
    /**
     * Operation getStoreMembershipLevel
     *
    ...
    /**
     * Operation getStoreMembershipLevelWithHttpInfo
     *
     * Retrieve store membership level information
     *
     * @param  string $storeId The store id (required)
    ...
    /**
     * Operation getStoreMembershipLevelAsync
     *
     * Retrieve store membership level information
     *
     * @param  string $storeId The store id (required)
    ...
    /**
     * Operation getStoreMembershipLevelAsyncWithHttpInfo
     *
     * Retrieve store membership level information
     *
     * @param  string $storeId The store id (required)
    ...
    protected function getStoreMembershipLevelRequest($storeId)
    {
        ...
        $resourcePath = '/api/v2.0/stores/{storeId}/membership-level';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
